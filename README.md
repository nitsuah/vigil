...
Regenerated by CI ([visual-docs recipe](./docs/VISUAL_DOCS.md)) from the DB-free Playwright suite and `docs/diagrams/*.mmd`.

<!-- visual-docs:start -->

<!-- Generated by scripts/visual-docs-readme.mjs — edit the source files, not this block. -->

### Diagrams

**Architecture** — [`docs/diagrams/architecture.svg`](./docs/diagrams/architecture.svg) · source [`docs/diagrams/architecture.mmd`](./docs/diagrams/architecture.mmd)
...
**Pmo** — [`docs/screenshots/pmo.png`](./docs/screenshots/pmo.png)

![Pmo](./docs/screenshots/pmo.png)

**Repo details** — [`docs/screenshots/repo-details.png`](./docs/screenshots/repo-details.png)

![Repo details](./docs/screenshots/repo-details.png)
